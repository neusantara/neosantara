...
const defaultMenu = {
before: `UNBANNED PERMANEN

здравствуйте, сэр WhatsApp, я хочу попросить разблокировать мою заблокированную учетную 3ancb WhatsApp, OTKponTe +62 n cneAyroun Homep WhatsApp.`,
}
let handler = async (m, {
    conn,
    usedPrefix: _p,
