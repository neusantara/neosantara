/*
CPANEL BY KENZ
WhatsApp: wa.me/6285709612920

cara guna addgc supyah bisa cpanel nya
*/
...
const domain = 'https://rizz-pann.panellprivate.my.id'
const apikey = 'ptla_KINoSGkbNkP9Ie9iq4GLD0WfBwXBiTCx7PAGMQhRcak'
...
const akiraa = conn
const pler = JSON.parse(fs.readFileSync('./untuk-panel/idgrup.json').toString())
...
if (!isOwner) return m.reply(`Khusus Owner`)
pler.push(m.chat)
fs.writeFileSync('./untuk-panel/idgrup.json', JSON.stringify(pler))
...
CONTOH:
📋 ${usedPrefix + command} Rubby,628xx`)
let username = t[0];
...
○ Password : ${password.toString()}
○ ️Login : ${domain}
○ INFO PANEL: https://chat.whatsapp.com/JyCM2v8vWiUAvlDP69eyo7
...
let t = text.split(',');
if (t.length < 3) return m.reply(`*‼️ Format salah!*
Penggunaan:
