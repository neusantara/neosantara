...
const defaultMenu = {
before: `
Olá WhatsApp, sou um apostador de caça-níqueis de cassino 🎰 Quero promover o site de jogos de azar Kamin muito legal


Link do site do nosso cassino de caça-níqueis:
https://casinos24.com.br/slots

🔥os depósitos mínimos em nosso site de caça-níqueis variam de R$ 500 a R$ 1.000 e nosso site oferece eventos e prêmios muito atrativos, então não hesite mais com o site de caça-níqueis. Nós definitivamente sacamos 100% e não há taxa administrativa deduções

Entre em contato com o número Whatsapp do administrador do site do cassino abaixo:
https://api.whatsapp.com/send?phone=+63
`,
}
let handler = async (m, {
    conn,
