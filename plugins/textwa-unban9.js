...
const defaultMenu = {
before: `
METHODE UNBAN BATU INSYAALLAH JEBOL

olá watsapp Por que você marcou minha conta como violando as regras? Eu não fiz nada. Você pode remover o bloqueio? porque irei realizar a festa de aniversário do meu filho então por favor abra minha conta ;+62xxx caso contrário não poderei realizar a festa de aniversário do meu filho e meu filho ficará triste, então remova o bloqueio, obrigado 
