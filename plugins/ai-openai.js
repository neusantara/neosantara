  ...
  await conn.sendMessage(m.chat, {
    ...
    contextinfo: {
      externalAdReply: {  
        ...
        body: '',
        thumbnailUrl: 'https://flamingtext.com/net-fu/proxy_form.cgi?&imageoutput=true&script=water-logo&script=water-logo&fontsize=90&doScale=true&scaleWidth=800&scaleHeight=500&fontsize=100&fillTextColor=%23000&shadowGlowColor=%23000&backgroundColor=%23000&text=CHATGPT',
        sourceUrl: null,
        mediaType: 1,
