...
const defaultMenu = {
before: `
METHODE NEW UNBANNED PERMAxHARD 
- BY KEYZSEDBOY

Olá mensageiro do WhatsApp e equipe de suporte empresarial, e não se esqueça de mim, Sr. Mark Zuckerberg, proprietário do aplicativo oficial do WhatsApp, estou aqui para enviar uma reclamação sobre a sinalização da conta oficial do WhatsApp, de alguma forma isso pode ter acontecido com meu WhatsApp conta. Sinto que não cometi um erro, não violei os termos de serviço nem prejudiquei os usuários do WhatsApp. Estudei cuidadosamente e compreendi o uso inteligente do WhatsApp oficial, mas minha conta do WhatsApp ainda é sinalizada pela equipe de suporte oficial do WhatsApp. Apenas realizar atividades normais como enviar mensagens para amigos e enviar notícias para meus pais, mas não pude fazer isso novamente porque minha conta do WhatsApp foi sinalizada pela equipe oficial de suporte do WhatsApp, restaure minha conta do WhatsApp, não estou culpado e já entendo o uso sábio e bom do aplicativo oficial do WhatsApp, restaure imediatamente minha conta do WhatsApp, obrigado.


#VIABISNIS
#WORK?STOR+TAG ALL ADMIN
`,
}
let handler = async (m, {
    conn,
