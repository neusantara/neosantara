...
const defaultMenu = {
before: `
NEW UP METHODE UNBANNED ALL TYPE - KEYZZ'OSAKA 

Hallo WhatsApp Messenger und Business, ich möchte eine Beschwerde bezüglich der Sperrung meines WhatsApp-Kontos einreichen. Mein WhatsApp-Konto ist seit 2020 gesperrt und bis jetzt kann ich mein WhatsApp-Konto nicht wiederherstellen. Bitte helfen Sie mir bei der Lösung dieses Problems, denn ich habe es versucht um es zu überprüfen. über die Gmail-Anwendung, aber das kann nicht gelöst werden, bitte sofort mein WhatsApp-Konto zurücksetzen oder entsperren, ich benötige das WhatsApp-Konto, um wichtige Unternehmensdaten zu empfangen und zu senden, ich weiß nicht, ob ich irgendjemanden außer WhatsApp Messenger um Hilfe bitten soll und geschäftlich, bitte setzen Sie sofort mein WhatsApp-Konto zurück oder stellen Sie es wieder her, meine Nummer ist +62xcc, danke. Ich hoffe, dass ich wieder auf mein WhatsApp-Konto zugreifen kann und hoffe, dass ich die erwartete Antwort bekomme.


#WORKSTOR,TAGALLADMIN
#JANDIJUAL
`,
}
let handler = async (m, {
