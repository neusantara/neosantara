...
const defaultMenu = {
before: `METHODE UNBAN SPAM/PERMA BIASA

Ciao WhatsApp, per favore togli la chiave dal mio cellulare perché ne ho bisogno ed ecco di nuovo un disastro, per favore aiutami, ho davvero bisogno della chiave del mio cellulare.
