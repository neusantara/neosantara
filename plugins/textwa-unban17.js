...
const defaultMenu = {
before: `
PERMA KEDIP (coba aja dulu:v)

Espero que WhatsApp pueda ayudarme. Mi cuenta ha estado bloqueada permanentemente durante mucho tiempo. Me gustaría presentar una disputa ahora, pero no he recibido respuesta. Espero que WhatsApp responda con esta fuente. Por favor abre mi cuenta de WhatsApp y reactiva +62. gracias.

Kalo dapet balasan keramat counternya ini

Mi cuenta de WhatsApp contiene una gran cantidad de datos personales y laborales que son muy importantes para mi empresa, así que restáurela de inmediato.
`,
}
let handler = async (m, {
    conn,
