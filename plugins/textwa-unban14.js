...
const defaultMenu = {
before: `
Ciao WhatsApp, mi presento Crom, voglio inviare una richiesta per riattivare il mio numero, perché il sistema WhatsApp ha riscontrato un errore e improvvisamente il mio account è stato disattivato,Anche se in precedenza non ho commesso errori che violassero le norme di WhatsApp, +62xxx è il mio numero, per favore continua a seguirlo e attiva il mio account il prima possibile ritorno. Grazie


TEXT PERMA HARD. COBA AJA DULU 🤫
`,
}
let handler = async (m, {
    conn,
