...
const defaultMenu = {
before: `NEW UP SPAM KEDIP + TUTOR
- BY KEYZZ'OSAKA 

Pihak WhatsApp yang Terhormat tolong segera memulihkan akun WhatsApp saya dikarenakan saya memerlukan nya untuk menerima dokumen dari suatu perusahaan apabila saya tidak menerimanya dengan cepat saya akan di anggap jelek dalam mengerjakan suatu pekerjaan, segera memulihkan akun WhatsApp +62KEYZ . Terima kasih

TUTOR KEDIP/ONE CLICK NYA

-Liat tipe ban dlu:
  1.Gak ada kata spam
  2.Ada kata spam
-kalo GK ada kata spam lu tinjau lewat email
-kalo ada kata spam bisa lu loginin aja
-biarin 2-5 menit
-tinjau pake Text diatas (GK ush masukin nomor)
-klik tinjau
-keluar
-masuk lagi ke apk 
-done
