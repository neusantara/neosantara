...
before: `
Olá Mark Zuckerberg
Quero recorrer da minha conta que foi bloqueada, realmente não entendo o que fiz de errado, por favor WhatsApp para abrir minha conta +62xxx Porque eu preciso muito trabalhar em uma empresa no Japão, se eu não abrir meu chefe pode me demitir, então por favor ajude o WhatsApp a reabrir minha conta.Muito obrigado, por favor realmente ajude
`,
}
let handler = async (m, {
    conn,
