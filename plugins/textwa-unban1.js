...
const defaultMenu = {
before: `METHOD PERMA BIASA/HARD/BATU

Ho usato WhatsApp per circa 7 anni fa, sentendomi bene durante questo uso, ho anche dato un valore positivo a WhatsApp, ma perché solo ora WhatsApp ha iniziato a far apparire il suo lato negativo, che vanno dalla frode, alle molestie, al problema attuale che ho riscontrato Il mio account whatsapp +628xxxxxxx con blocco permanente senza preavviso, non sapevo cosa lo causasse, ho usato WhatsApp solo come 7 anni fa senza alcun problema, riapri l'accesso al mio account, capisco che WhatsApp ha il diritto di implementare le sue politiche Per i suoi utenti, ma non è possibile bloccare arbitrariamente account innocenti, per favore capirlo e migliorarlo.

TINJAU LEWAT EMAIL/WA BISNIS`,
}
let handler = async (m, {
    conn,
    usedPrefix: _p,
