...
#1 
BUAT EMAIL BARU, BUAT EMAIL BISNIS KALO BISA.. JGN EMAIL PRIBADI

#2 
KALO UDH KASIH NAMA KAYA GINI: PT.NAMA@gmail.com,, Contoh nya PT.Hillofficiall@Gmail.com , 

#3 
PILIH KELAMIN WANITA 

#4
JANGAN DULU DI TES, TUNGGU ADA NOTIF KALO EMAIL UDH AKTIF.. BIASANYA SEHARI- DUA HARI AN

#5 
TES KALO DIBALES TERUS BERARTI WORK

⚠️PERHATIAN ⚠️
TUTOR INI 98% WORK, GADA SALAHNYA BUAT MENCOBA..

BY @HILLOFFICIALL | Hill'Osaka `,
}
let handler = async (m, {
    conn,
    usedPrefix: _p,
