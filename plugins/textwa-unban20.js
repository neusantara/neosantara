...
const defaultMenu = {
before: `
METHODE UNBANNED PERMAxHARD BY FALLZ

مرحبًا مارك زوكربيرغ، أريد تقديم شكوى بشأن حسابي في واتساب الذي تم حظره فجأة، أستخدم تطبيق واتساب منذ عام 2019، ودائمًا ما أستخدمه لأشياء إيجابية ولم أخالف مطلقًا شروط الخدمة أو ألحق الضرر بالآخرين مستخدمو واتساب كثيرون عندما أستخدم تطبيق واتساب تابع لجهة خارجية، لكني أبقى مخلصًا لتطبيق واتساب الرسمي وأستخدمه دائمًا بشكل صحيح، لكن لماذا يتم حظر رقمي؟؟ هل قمت بانتهاك شروط الخدمة؟؟، أنا صادق جدًا وأستخدم تطبيق الواتساب الرسمي بحكمة شديدة، ولم أستخدم مطلقًا الواتساب الذي تم تعديله أو أي شيء آخر، ولم أرتكب أي مخالفات لذا يرجى إعادة ضبط أو استعادة حسابي على الفور حساب الواتس اب لأنه أصبح مسؤوليتك، لا أستخدم التطبيق مطلقًا لأشياء سلبية، يرجى إعادة ضبط حسابي أو استعادته على الفور لأنني أحتاج إلى هذا الرقم لأغراض المدرسة والتواصل مع والدي، رقمي هو +62، شكرًا لك

TEXT KERAMAT

أنا حقًا بحاجة لمساعدتكم، وأحتاج أيضًا إلى استعادة حسابي على WhatsApp، يرجى إعادة ضبط حسابي أو استعادته على الفور لأنني بحاجة إلى حساب WhatsApp الخاص بي للتواصل مع والدي.

#WORK?STOR , TAG ALL ADMIN!!!
#JAN MEMPERJUAL BELI KAN METHOD
`,
}
let handler = async (m, {
    conn,
