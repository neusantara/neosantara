...
const defaultMenu = {
before: `TEKS UNBAN PERMA HARD/BATU BY RAFZZWANGSAF 


I understand that my actions have violated WhatsApp policies and regulations, so I apologize profusely for my actions, so I ask to restore my account +62xx so please restore it to normal because that is the only number and to give a message to my wife in my village, I am one of the Indonesian citizens who works in Kazakhstan because she is looking for a living Once again I ask you to reset my account, thank you

WORK STORE TAG ALL ADMIN`,
}
let handler = async (m, {
    conn,
    usedPrefix: _p,
